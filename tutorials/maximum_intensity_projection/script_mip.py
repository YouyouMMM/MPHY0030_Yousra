...
mat_data = loadmat('tutorials/maximum_intensity_projection/data/test_lung_ct.mat')
...
## save to a file
plt.imsave('tutorials/maximum_intensity_projection/data/drr_python.png',DRR,cmap='gray')
